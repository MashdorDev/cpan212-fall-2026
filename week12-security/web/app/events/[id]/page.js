  ...
  return (
    <article>
      ...
      <dl className={styles.facts}>
        ...
        <dt>Spots</dt>
        <dd>
          {event.rsvpCount} of {event.capacity} taken{event.rsvpCount >= event.capacity && ' (full)'}
        </dd>
      </dl>
      {event.imageUrl && (
        // A plain <img> for the same reason as in EventCard: the image can come from any https address.
