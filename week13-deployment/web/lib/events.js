...
async function fetchFromApi(path) {
  return fetch(`${API_ORIGIN}${path}`, {
    ...
    cache: 'no-store',
    // A free Render instance that has been idle for 15 minutes takes about a minute to wake up.
    // The 5 seconds used in earlier weeks would show the error page on the first visit after every nap.
